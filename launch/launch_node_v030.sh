...
SPEC="{\"method\":\"dflash\",\"model\":\"/cache/huggingface/hub/$DRAFTER\",\"num_speculative_tokens\":$SPEC_K,\"rejection_sample_method\":\"block\",\"num_speculative_tokens_per_batch_size\":[[1,1,7],[2,3,5],[4,64,4]],\"disable_eagle_block_drop\":true}"
